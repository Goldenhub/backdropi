...
export function UnsplashPicker() {
  ...
  const { query, setQuery, photos, loading, error, loadMore, hasMore } = useUnsplashSearch()
  const activeId = state.background.type === 'unsplash' ? state.background.photoId : null
